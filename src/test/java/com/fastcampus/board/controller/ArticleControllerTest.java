...
import board.domain.dto.ArticleDto;
import board.domain.dto.ArticleWithCommentsDto;
import board.domain.dto.HashtagDto;
import board.domain.dto.UserAccountDto;
import board.domain.dto.request.ArticleRequest;
import board.domain.dto.response.ArticleResponse;
...
class ArticleControllerTest {
    ...
    @WithUserDetails(value = "eunchanTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
