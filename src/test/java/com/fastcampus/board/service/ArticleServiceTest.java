...
class ArticleServiceTest {
    ...
    @Test
    void gevenArticleInfo_whenSavingArticle_thenSavesArticle(){
        //Given
        given(articleRepository.save(any(Article.class))).willReturn(null);

        //When
        sut.saveArticle(ArticleDto.of(LocalDateTime.now(), "EunChan", "title", "content", "hashtag"));
    ...
    @Test
    void gevenArticleInfo_whenUpdatingArticle_thenUpdatesArticle(){
        //Given
        given(articleRepository.save(any(Article.class))).willReturn(null);
    ...
    @Test
    void gevenArticleId_whenDeletingArticle_thenDeltesArticle(){
        //Given
